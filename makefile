...
# Znacznik czasowy: 2020-12-25 16:38:01.011109
#

OUTDIR		:= build-dir

CC          := gcc
CC_FLAGS    := -pedantic -DINSIDE_DANTE -fmax-errors=5 -D_ANSI_OUTPUT -ggdb3 -xc -Wno-error=unused-parameter -Werror=vla -Wno-parentheses -Wextra -std=c11 -Wall -D_GNU_SOURCE -fdiagnostics-color -Wno-error=parentheses -Wno-error=implicit-fallthrough -Werror 
